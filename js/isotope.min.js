...
function (t, e) {
    ...
    function o(t) {
        ...
        return e || a("Style returned " + e + ". Are you running this code in a hidden iframe on Firefox? See https://bit.ly/ge" +
                "tsizebug1"),
        e
    }
    function n() {
    ...
    c._getMeasurement = function (t, e) {
        ...
        n
            ? ("string" == typeof n
                ...
                : n instanceof HTMLElement && (o = n), this[t] = o
                ? i(o)[e]
                : n)
            : this[t] = 0
    },
...
function (t, e) {
    ...
    o._getItemLayoutPosition = function (t) {
        ...
        for (var n = this.options.horizontalOrder
            ? "_getHorizontalColPosition"
            : "_getTopColPosition", s = this[n](o, t), r = {
            x: this.*s.col,
            y: s.y
    ...
    o._manageStamp = function (t) {
        ...
        for (var h = this._getOption("originTop"), d = (h
            ? o.top
            : o.bottom) + i.outerHeight, l = a; l <= u; l++) 
